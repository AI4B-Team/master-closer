...
.device-wrap{position:relative;width:100%;max-width:540px;}
...
.float-chip-1{top:-18px;left:-70px;animation-delay:0s;}
.float-chip-2{top:34%;right:-78px;animation-delay:1.2s;max-width:200px;}
.float-chip-3{bottom:-16px;right:-62px;animation-delay:2.4s;}
