...
function mapCodes(zone: string, codes: string[]) {
  for (const code of codes) {
    // Duplicates used to be silently overwritten by whichever list came last,
    // which quietly moved real area codes into the wrong zone. First mapping wins.
    if (AREA_CODE_TZ[code]) continue;
    AREA_CODE_TZ[code] = zone;
  }
}

mapCodes("America/New_York", [
  "201","202","203","207","212","215","216","220","223","229","234","239","240","267","272","276","301","302","304","305","321","326","330","332","339","346","347","351","352","380","386","401","404","407","410","412","413","419","423","434","440","443","445","470","475","478","484","513","516","518","540","551","561","567","570","571","585","586","603","606","607","609","610","614","616","617","631","646","667","678","680","681","689","703","704","706","716","717","718","724","727","732","734","740","743","754","757","762","770","772","774","781","786","802","803","804","810","813","814","820","828","839","843","845","848","850","854","856","857","859","862","863","864","865","878","904","908","910","912","914","915","917","919","929","931","937","941","947","954","959","973","978","980","984","989",
]);
mapCodes("America/Chicago", [
  "205","210","214","217","224","251","256","262","270","281","309","312","314","316","318","319","320","325","331","334","337","361","364","402","405","409","414","417","430","432","447","463","469","479","501","502","504","507","512","515","531","539","557","563","573","580","601","608","612","615","618","620","630","636","641","651","659","660","662","682","708","712","713","715","731","737","763","769","773","779","785","806","812","815","816","817","830","832","870","901","903","913","918","920","930","936","940","945","952","956","972","979","985",
]);
...
mapCodes("America/Los_Angeles", [
  "206","209","213","253","279","310","323","341","360","408","415","424","425","442","458","503","509","510","530","541","559","619","626","628","650","657","661","669","702","707","714","725","747","753","760","775","805","818","831","840","858","909","916","924","925","935","949","951","971",
]);
...
/** Wall-clock hour (0–23) of an instant in a given zone. */
export function localHourIn(at: Date, timezone: string): number {
  return Math.floor(localClock(at, timezone).minute / 60);
}

/**
 * Same calendar day in `timezone`, moved to `hour` local time. Used when a
 * booking has to be re-proposed at the hour the prospect actually asked for.
 */
export function withLocalHour(at: Date, timezone: string, hour: number): Date {
  const clock = localClock(at, timezone);
  const deltaMinutes = hour * 60 - clock.minute;
